...
function UserPost() {
    ...
    const { yourPosts, setYourPosts } = useContext(PostContext);
    ...
    const fetchPosts = async () => {
        ...
        setYourPosts(response.data.userPosts);
        setIsLoading(false);
    }
    ...
    const onCommentHandler = async (postId) => {
        ...
        if (comment) {
            try {
                await axios.patch(`${url}posts/comment`, { postId, userId, comment });
                setComment('');
                fetchPosts()
            } catch (error) {
                console.error(error);
                                            ...
                                            <div className='bg-white rounded-lg p-4 border-2 border-neutral-300 mt-2'>
                                                <div className='flex justify-between'>
                                                    ...
                                                    <div className='relative'>
                                                        ...
                                                        <dialog id={`my_modal_${post._id}`} className="modal absolute">
